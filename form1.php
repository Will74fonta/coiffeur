...
$toemails[] = array(
				'email' => 'contact@artydesignstudio.fr', // Your Email Address
				'name' => 'Test' // Your Name
			);
...
$fromemail = array(
				'email' => 'contact@artydesignstudio.fr', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Arty' // Company Name
			);
...
$mail->Username = 'contact@artydesignstudio.fr'; // Votre adresse e-mail Infomaniak
$mail->Password = 'Erneste.74'; // Votre mot de passe Infomaniak
$mail->SMTPSecure = 'ssl'; // Utilisation de TLS (SSL est également possible)
$mail->Port = 465; // Port SMTP d'Infomaniak
...
$autoresponder->isSMTP(); // Utilisation de SMTP
$autoresponder->Host = 'mail.infomaniak.com'; // Serveur SMTP d'Infomaniak
$autoresponder->SMTPAuth = true; // Activation de l'authentification SMTP
$autoresponder->Username = 'contact@artydesignstudio.fr'; // Votre adresse e-mail Infomaniak
$autoresponder->Password = 'Erneste.74'; // Votre mot de passe Infomaniak
$autoresponder->SMTPSecure = 'ssl'; // Utilisation de TLS (SSL est également possible)
$autoresponder->Port = 465; // Port SMTP d'Infomaniak
